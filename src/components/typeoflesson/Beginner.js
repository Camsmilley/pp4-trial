  ...
  return (
    ...
    <div class="text-start">
      <div class="col-12">
        ...
        <span className="text-warning">Guru</span> has created the international standards for Surfing Instructors for beginner level surfing.  A summary is below.</h3>
      </div>
